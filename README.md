...
троих только email, у троих только телефон. В ответе возвращает информацию о созданных получателях.
...
В теле запроса должно быть количество создаваемых получателей - receiverCount.
 ...
 ```
Возвращает информацию о созданных получателях в ответе.